...
/* CVUT 2016 - segmenter implementation file */
/* segmenter v1.4 */
...
// copy features into the kmeans object
  for (r=0;r<nr;r++) for (c=0;c<nc;c++) for (i=0;i<nfeat;i++) kmeans.arr[i][r][c]=feat[i][r][c];
// optional spatial feature - image coordinates
...
// copy result into probability maps array
